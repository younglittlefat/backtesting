...
## ETF标的预筛选
python -m etf_selector.main --data-dir data/chinese_etf --output results/trend_etf_pool.csv --target-size 10 --min-turnover 100000 --min-volatility 0.15 --max-volatility 0.80 --adx-percentile 70 --ret-dd-percentile 70 --momentum-min-positive
