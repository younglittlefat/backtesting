...
### 策略2：MACD交叉策略 + 止损
# ./run_backtest.sh --stock-list results/trend_etf_pool_2019_2021_optimized.csv --strategy macd_cross --optimize --data-dir data/chinese_etf/daily --save-params config/macd_strategy_params.json --enable-loss-protection --enable-adx-filter --confirm-bars-sell 2 --output-dir results/macd_enable-loss-protection_enable-adx-filter_confirm-bars-sell_2
