...
# -*- coding: utf-8 -*-
"""
V2 Portfolio Backtest Runner - 50 ETF Static Pool with Event Mode (Baseline)
"""
import sys
import os
import logging
...
def main():
    config_path = 'experiment/etf/v2_vs_v1_comparison/configs/tuning/v2_bull_50etf_cluster3.json'
    output_dir = 'results/v2_50etf_cluster3_p03_event'

    print("=" * 80)
    print("V2 Static 50 ETF Pool Backtest - Event Mode (Baseline)")
    print("=" * 80)
    ...
    print("- trend_state_mode: 'event' (DEFAULT)")
    print("- Trend ON after buy crossover")
    print("- Original behavior for comparison")
    print("=" * 80)
    ...
    try:
        ...
        print('\n' + '=' * 80)
        print('V2 50 ETF Cluster3 - Event Mode Results (Baseline)')
        print('=' * 80)
