...
#
# 用法：
#   ./mega_test_kama_greedy_parallel.sh                    # 执行完整实验流程（默认并发度8）
...
STRATEGY_DESCRIPTION="KAMA策略贪心筛选超参组合测试（并发版本）"
...
TEMP_PARAMS_PATH="config/test/kama_single_adx_score_strategy_params.json"
OUTPUT_BASE_DIR="experiment/etf/selector_score/single_primary/mega_test_kama_single_adx_score_parallel_$(date +%Y%m%d_%H%M%S)"
START_DATE="20220102"
END_DATE="20240102"
...
main() {
    ...
    # 正常执行模式
    greedy_print_header "KAMA策略贪心筛选超参组合测试（并发版本）"
